...
icon1.onclick = function () {
    ...
    if (document.body.classList.contains("dark-theme")) {
        ...
        document.getElementById('icon1').src = 'assets/img/icons/sun.png';
        ...
        document.getElementById('icon1').src = 'assets/img/icons/moon.png';
...
icon2.onclick = function () {
    ...
    if (document.body.classList.contains("dark-theme")) {
        ...
        document.getElementById('icon2').src = 'assets/img/icons/sun.png';
        icon2.title = "Click for Light Mode";
        localStorage.setItem('darkMode', 'enabled'); //store this data if dark mode is on
    } else {

        // document.getElementById('icon2').src = 'img/icons/moon.png';
        document.getElementById('icon2').src = 'assets/img/icons/moon.png';
...
if (localStorage.getItem('darkMode') == 'enabled') {
    ...
    icon1.src = "assets/img/icons/sun.png";
    icon2.src = "assets/img/icons/sun.png";
